...
import iphone_screen from '../assets/images/iphone-screen-with-shadow.png';
        ...
        <div className="section-content text-center">
          <div className="row">
            ...
            <div className="col-md-4 d-none d-md-block d-lg-block">
              <div className="feature-mobile"> <img src={iphone_screen} className="img-fluid wow fadeInUp"/> </div>
            </div>
            <div className="col-md-4 col-sm-12">
              <div className="media single-feature wow fadeInUp" data-wow-delay="0.2s">
